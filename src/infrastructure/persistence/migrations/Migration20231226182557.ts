...
export class Migration20231226182557 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "rivers" ("uuid" uuid not null default gen_random_uuid(), "created_at" timestamptz(6) not null default CURRENT_TIMESTAMP, "updated_at" timestamptz(6) null, "name" varchar(255) not null, "state_id" uuid not null, "description" varchar(255) not null, "lat" varchar(255) not null, "long" varchar(255) not null, "access" varchar(255) not null, constraint "rivers_pkey" primary key ("uuid"));');
